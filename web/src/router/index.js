...
import EstadisticasDonacionesPorMes from '@/components/stats/donacionesPorMes'
...
const routes = [
    ...
    {
        path: '/estadisticas/donacionespormes',
        name: 'EstadisticasDonacionesPorMes',
        component: EstadisticasDonacionesPorMes,
        meta: {title: 'Estadisticas: Donaciones por mes'}
    },
    {
